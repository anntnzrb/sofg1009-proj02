...
<path d="M21.54 22.976L16.155 15.796H20.1938L14.8088 8.616H17.5013L10.77 0L4.03875 8.616H6.73125L1.34625 15.796H5.385L0 22.976H9.42375V28.72H12.1163V22.976H21.54Z" fill="black" fill-opacity="0.4"/>
</svg>
            Bosques
          </Button>
          <Button class="flex gap-3 justify-center items-center" style="border-radius: 80px;
